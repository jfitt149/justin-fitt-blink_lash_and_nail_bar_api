...
function isOptionalNullable(type, value) {
  return (type.startsWith('Optional<Nullable<') || type.startsWith('Nullable<Optional<')) && isNullOrMissing(value);
}
export { arrayEntries, coerceNumericStringToNumber, coerceStringOrNumberToBigInt, createSymmetricSchema, identityFn, isNullOrMissing, isNumericString, isOptional, isOptionalNullable, literalToString, objectEntries, objectKeyEncode, omitKeysFromObject, once, toValidator };